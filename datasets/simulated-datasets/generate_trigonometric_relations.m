...
%         
%     case 2 
%         X(:,1) = 2 * sin(X(:,2)) + normrnd(0,0.05,[n,1]);
%         Y(:,1) = 3 * cos(X(:,2)) + normrnd(0,0.05,[n,1]);
%         Y(:,2) = 4 * cos(X(:,2)) + normrnd(0,0.05,[n,1]);
%         
%     case 3 
%         X(:,1) = 2 * sin(X(:,2)/2) + normrnd(0,0.05,[n,1]);
%         Y(:,1) = 3 * cos(X(:,2)/3) + normrnd(0,0.05,[n,1]);
%         Y(:,2) = 4 * cos(X(:,2)/4) + normrnd(0,0.05,[n,1]);
